...
class _$RegisterRequestImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RegisterRequest(login: $login, firstName: $firstName, lastName: $lastName, email: $email, langKey: $langKey, password: $password)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('langKey', langKey))
  ...
  int get hashCode => Object.hash(
      runtimeType, login, firstName, lastName, email, langKey, password);
